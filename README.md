...
- 📄 **Creates tailored ATS-friendly CVs on request** by foregrounding the target role without erasing a candidate's broader verified strengths, then verifies content density, hierarchy, and reading order.
